...
export const responseLoggingMiddleware: MiddlewareFunction = async (
  request: NextRequest,
  event: NextFetchEvent
) => {
...
export const errorLoggingMiddleware: MiddlewareFunction = async (
  request: NextRequest,
  event: NextFetchEvent
) => {
  try {
...
export const apiLoggingMiddleware: MiddlewareFunction = async (
  request: NextRequest,
  event: NextFetchEvent
) => {
