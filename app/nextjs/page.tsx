...
import DynamicRoutesExample from "@/components/nextjs/DynamicRoutesExample";
import RouteGroupsExample from "@/components/nextjs/RouteGroupsExample";
import ImageOptimizationDemo from "@/components/nextjs/ImageOptimizationDemo";
import { Metadata } from "next";
import Link from "next/link";

export const metadata: Metadata = {
  title: "Demos - Next.js Learning App",
  description: "Explore Next.js demos and examples.",
};
    ...
    <main>
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-3xl font-bold text-center mb-8">Next.js Demos</h1>

          <div className="mb-12">
            <h2 className="text-2xl font-semibold text-center mb-6">Rendering Methods & Caching</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <Link
                href="/nextjs/rendering/ssr-demo"
              ...
              <Link
                href="/nextjs/rendering/ssg-demo"
              ...
              <Link
                href="/nextjs/rendering/isr-demo"
              ...
              <Link
                href="/nextjs/rendering/tag-revalidation-demo"
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
              <div className="p-6">
                ...
                <div className="mt-4 text-center">
                  ...
                  >
                    🚀 See Live Example: /nextjs/routing/demo/123
                  </Link>
                </div>
              </div>
            </div>
