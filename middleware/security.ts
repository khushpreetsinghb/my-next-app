...
export const inputValidationMiddleware: MiddlewareFunction = async (
  request: NextRequest,
  event: NextFetchEvent
) => {
...
export const botDetectionMiddleware: MiddlewareFunction = async (
  request: NextRequest,
  event: NextFetchEvent
) => {
...
export const ipBlockingMiddleware = (blockedIPs: string[]): MiddlewareFunction => {
...
export const requestSizeLimitMiddleware = (maxSizeBytes: number): MiddlewareFunction => {
  return async (request: NextRequest, event: NextFetchEvent) => {
...
export const requestTimingMiddleware: MiddlewareFunction = async (
  request: NextRequest,
  event: NextFetchEvent
) => {
