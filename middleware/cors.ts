...
export const corsResponseMiddleware: MiddlewareFunction = async (
  request: NextRequest,
  event: NextFetchEvent
) => {
  const origin = request.headers.get('origin')
...
export const strictCorsMiddleware: MiddlewareFunction = async (
  request: NextRequest,
  event: NextFetchEvent
) => {
...
export const devCorsMiddleware: MiddlewareFunction = async (
  request: NextRequest,
  event: NextFetchEvent
) => {
...
export const validateOriginMiddleware = (allowedOrigins: string[]): MiddlewareFunction => {
